...
const base64Credentials = Buffer.from('localhost:3000:dBB4b3hqYdqcrduUF9X9').toString('base64');
...
class NewPost extends React.Component {
    ...
    checkRef = async (event) => {
        //send POST req to check source and get back with result
        //if sure,
        //         POST req to get source metadata
        //         move onto next stage
        //if unsure, alert user in modal


        //TODO MAKE FACT CHECK POST REQ
        ...
        if (response){
            ...
            alert('Sorry - your source isn\'t verified by our metrics. Please try another source.')
        }
    };
    ...
    stage1(){
        return (
            <>
                ...
                <Button variant="contained" color="primary" id={"opinion_button"} name={'opinion'} onClick={this.categorySetOp}>
                    Opinion
                </Button>
                <br/>
                or
                <br/>
                <Button variant="contained" onClick={this.categorySetDisc} name={'disc'} id={"discussion_button"}>Discussion</Button>
            </>
        )
        ...
        if(this.state.category === 1){
            stage2 = (
                <>
                    ...
                    <TextField
                        ...
                        fullWidth
                    />
                    <Button variant="contained" onClick={this.checkRef} id={"discussion_button"}>Next</Button>
                </>
            )
        }
        else{
            ...
            stage2 = (
                <>
                    ...
                    <Button variant="contained" onClick={this.postDisc} id={"discussion_button"}>Post</Button>
        ...
        if(this.state.category === 1){
            stage3 = (
                <>
                    ...
                    <Button variant="contained" onClick={this.postOpinion}>Post</Button>
                </>
            )
        }
        return (
